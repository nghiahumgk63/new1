    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate(
            [
                ...
                'title.required'=>'Bạn chưa nhập tên thể loại nè',
                'slug.required'=>'Bạn chưa nhập slug cho thể loại nè',
                'description.required'=>'Bạn chưa nhập mô tả nè',
                'trailer.required'=> 'Bạn chưa nhập link trailer của phim nè',
            ]
        );
        $movie = new Movie();
        ...
        toastr()->success('Bạn đã thêm thành công', 'Phim');
    ...
    public function filter_topview(Request $request){
        ...
        foreach($movie as $key => $mov){
            ...
            $output.='<div class="item post-37176">
                              ...
                              <div class="viewsCount" style="color: #9d9d9d;">'.$mov->port_view.' lượt xem</div>
