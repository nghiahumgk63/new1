            ...
            <table class="table-striped" id="datamovie">
              ...
              <tbody class="order_position">
                ...
                <tr id="{{$cate->id}}">
                  ...
                  <td>
                      {!! Form::open(['method'=>'DELETE','class'=>'form-cate','route'=>['category.destroy',$cate->id],'onsubmit'=>'return confirm("Bạn có chắc muốn xóa?")']) !!}
                      ...
                      <a href="{{route('category.edit',$cate->id)}}" class="btn btn-info btn-sm">Sửa</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
