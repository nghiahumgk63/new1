...
<div class="row container" id="wrapper">
            ...
            <div id="halim_related_movies-2xx" class="wrap-slider">
                     ...
                     <script>
                        ...
                        owl.owlCarousel({loop: true,margin: 6,autoplay: true,autoplayTimeout: 4000,autoplayHoverPause: true,nav: true,navText: ['<i class="bi bi-chevron-left"></i>', '<i class="bi bi-chevron-right"></i>'],responsiveClass: true,responsive: {0: {items:2},480: {items:3}, 600: {items:5},1000: {items: 6}}})});
                     </script>
                  </div>
